        ...
        <div className="min-h-full">
            ...
            <div className=" w-full  m-2 min-h-full relative top-[60px] ">
                ...
                <div className=" flex justify-between items-center w-1/2 fixed bottom-5 left-[25%] right-[25%] border-solid border-2 rounded-4xl pr-2 py-2  bg-gray-600 h-15 border-transparent">
                    <input name="question" id="question" className="w-[80%] border-0 rounded-3xl border-transparent h-full px-2 outline-none focus:outline-none focus:ring-0 focus:border-none m-5" type="text" onChange={event => setuserInput(event.target.value)} placeholder="Describe what to know" />
